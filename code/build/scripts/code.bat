...
set CLASSPATH=%APP_HOME%\lib\code-1.0-SNAPSHOT.jar;%APP_HOME%\lib\lanterna-3.0.1.jar

@rem Execute code
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CODE_OPTS%  -classpath "%CLASSPATH%" g76.Application %CMD_LINE_ARGS%
